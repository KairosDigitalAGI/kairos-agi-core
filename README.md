...
**Atendimento Instagram:** webhook assinado, fila de comentários/Direct, resposta manual e regras de palavra-chave com aprovação do Founder foram implementados. As regras começam pausadas. A ativação real ainda depende da migration, verify token, assinatura dos campos no app Meta e teste ponta a ponta; detalhes em [Atendimento Instagram](docs/modules/INSTAGRAM_ENGAGEMENT.md).
