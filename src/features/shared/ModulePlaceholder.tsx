...
export function ModulePlaceholder({ title, description, icon: Icon, vault }: ModulePlaceholderProps) {
  return (
    <section className="placeholder-page glass-panel">
      ...
      <div className="placeholder-grid"><div><Sparkles size={17} /><strong>Contratos compartilhados</strong><span>Sem lógica duplicada</span></div><div><LockKeyhole size={17} /><strong>Mock mode</strong><span>Sem integrações externas</span></div></div>
    </section>
  )
}
