...
export const storyboards: Record<string, StoryboardFrame[]> = {
  '00': [
    ...
    { scene: 3, title: 'Kairos em Ação', duration: '10–15 s', camera: 'Split-screen holográfico · câmera fixa com parallax digital', transition: 'Data stream wipe', visual: 'Interface dividida: Kairos (dashboard WhatsApp em tempo real) à esquerda e símbolo Kairos pulsando à direita. Dados fluindo entre os sistemas.', prompt: ep00GptPrompts[3].prompt },
