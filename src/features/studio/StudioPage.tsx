...
const cast = [
  ...
  { name: 'KAIROS', role: 'Assistente pessoal · pessoa-avatar Kairos', state: 'Press kit v1.0 disponível', detail: 'Mediador humano do elenco: recebe a ideia, organiza opções e devolve a decisão ao Founder. A nova ficha usa a ampulheta como tatuagem, broche ou detalhe do figurino.' },
  { name: 'ORION', role: 'Coordenação estratégica · guardião-ampulheta', state: 'Press kit v1.0 disponível', detail: 'Guardião de contexto e prioridades. Corpo, núcleo e silhueta repetem a geometria da ampulheta Kairos.' },
