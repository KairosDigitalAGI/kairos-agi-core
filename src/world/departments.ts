...
export const departments: Record<ModuleKey, Department> = {
  ...
  instagram: social, studio, clone: { ...studio, area: 'Identidade do Founder' }, characters: { ...studio, area: 'Character Studio' }, library: { ...studio, area: 'Biblioteca de filmes' }, video: { ...studio, area: 'Estúdio de vídeo local' }, 'money-lab': money,
