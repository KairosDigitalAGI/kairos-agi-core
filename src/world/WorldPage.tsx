  ...
  return (
    <section className="world-shell">
      ...
      <aside className="agent-inspector" aria-label={`Detalhes de ${selected.name}`}>
        ...
        <div className="inspector-task"><small>Tarefa atual</small><strong>{selected.task}</strong><ProgressBar value={selected.progress} color={selected.color} /><div><span>Progresso</span><b>{selected.progress}%</b></div></div>
      </aside>
